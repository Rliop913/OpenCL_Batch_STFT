...
public:
	...
	cl_float3* three_bander(float* powered_STFT, const ma_uint64& frame_length, const int& window_radix_size, const int& quot);
...
public:
	...
	cl_float3* cl_STFT(float* full_frame, const ma_uint64& full_length, const int& window_radix_2, const double& overlap_ratio, const int& both_side_z_padding_size, int& number_of_index);
	//void STFT_TESTER();
};
