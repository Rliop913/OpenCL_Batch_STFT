...
execute_process(
  COMMAND "/usr/bin/git" show-ref "ba364cd54fd431c76c045393b6522b4bff547f50"
  WORKING_DIRECTORY "/mnt/g/Dropbox/Dropbox/box_inside/git_branch/cpps/STFT_SYCL/STFT_SYCL/linux_build/_deps/whereami-external-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/ba364cd54fd431c76c045393b6522b4bff547f50")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "ba364cd54fd431c76c045393b6522b4bff547f50")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "ba364cd54fd431c76c045393b6522b4bff547f50")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/gpakosz/whereami.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/mnt/g/Dropbox/Dropbox/box_inside/git_branch/cpps/STFT_SYCL/STFT_SYCL/linux_build/_deps/whereami-external-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/g/Dropbox/Dropbox/box_inside/git_branch/cpps/STFT_SYCL/STFT_SYCL/linux_build/_deps/whereami-external-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
